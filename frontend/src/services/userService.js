...
const delFeatures = (id) => {
  console.log(authHeader());
  return axios.post(`${ADMIN_URL}deletefeaturebyid/${id}`, null, {
    headers: {
      "Content-Type": "application/json",
      "Access-Control-Allow-Origin": "*",
      ...authHeader(),
...
*/
const delProduct = (id) => {
  return axios.post(`${ADMIN_URL}deleteproductbyid/${id}`, null, {
    headers: {
      "Content-Type": "application/json",
      "Access-Control-Allow-Origin": "*",
      ...authHeader(),
...
const getallProductForQuotation = () => {
  console.log(authHeader());
...
const getfeaturebyproductid = (productId) => {
  return axios.get(
    `${MANAGER_URL}getfeaturesbyproductid?productId=${productId}`,
    {
      headers: {
        "Content-Type": "application/json",
        ...authHeader(),
...
const uploadFile = (file) => {
  ...
  return axios
    .post(`${ADMIN_URL}upload`, formData, {
      headers: {
...
const getfeaturebyproductidadmin = (productId) => {
  return axios.get(
    `${ADMIN_URL}getfeaturesbyproductidadmin?productId=${productId}`,
    {
      headers: {
        "Content-Type": "application/json",
        ...authHeader(),
